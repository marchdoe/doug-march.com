...
export const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    company: 'Spaceman',
    description:
      'Independent design and engineering practice. Clients included Jeffrey Zeldman, Rolex, The Nature Conservancy, Sapient Razorfish, bswift, RTIC Coolers, Framebridge, Intuit, LastPass, WorkAround, and others.',
  },
  {
    year: '2018',
    ...
    description:
      'Led the initiative to build a design system within the product team, encouraging sharing and reuse of code across all Atlantic properties.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'Led the rebrand of the consumer-facing site from Power Supply to Territory Foods, and built a React component library documented via Storybook.',
    bullets: [
  ...
  },
  {
    ...
    company: 'Interfolio',
    description:
      'Responsible for directly managing, supporting, and providing direction and leadership to the engineering team and other members of the product team.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'Worked across consumer-facing web and mobile applications, owning the full product lifecycle from prototyping through shipping.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'Co-developed new solutions in the eDiscovery field to lower cost and scale technology and people.',
    bullets: [
  ...
  },
  {
    ...
    company: 'Mixx',
    description:
      'Worked closely with product and engineering to define and implement new products and features across the Mixx platform.',
    bullets: [
