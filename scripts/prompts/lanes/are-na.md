---
id: are-na
register: warm-paper-collectors-ledger
affinity: interleaved, measured, even, single
---
...
## Atmosphere
A human, unhurried catalog — closer to a zine's contents page or a collector's card catalog than a keyboard-first app. Warm paper tones, visible grid lines like a ledger, a small thumbnail image beside each entry.
...
- DO NOT use a purple/violet accent
